...
import { createHash, validatePass } from '../utils/passwordHash.js'
...
export const initializePassport = () => {
        ...
        async (req, username, password, done) => {
            try {
                ...
                try {
                    ...
                    user = await usersModel.create({ first_name, last_name, age, email, password, cartId });
    ...
    passport.use('github', new github.Strategy(
        {
            clientID: "Iv1.6f6269becbd190ba",
            clientSecret: "5558af4c7f2ee867321eff352975e300c0e8aaf7",
